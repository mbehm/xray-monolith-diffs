...
void CEntityAlive::LoadBloodyWallmarks (LPCSTR section)
{
	...
	//РєР°РїР»Рё РєСЂРѕРІРё С РѕС‚РєСЂС‹С‚С‹С… СЂР°РЅ
...
/*	if(monster_community->team() != 255)
	...
	//РґРѕР±Р°РІРёС‚СЊ РєСЂРѕРІСЊ Рё РѕРіРѕРЅСЊ РЅР° РїР°СЂС‚РёРєР»С‹, РµСР»Рё РЅСѓР¶РЅРѕ
...
void	CEntityAlive::Hit(SHit* pHDS)
{
	...
	//ГЁГ§Г¬ГҐГ­ГЁГІГј Г±Г®Г±ГІГ®ГїГ­ГЁГҐ, ГЇГҐГ°ГҐГ¤ ГІГҐГ¬ ГЄГ ГЄ Г°Г®Г¤ГЁГІГҐГ«ГјГ±ГЄГЁГ© ГЄГ«Г Г±Г± Г®ГЎГ°Г ГЎГ®ГІГ ГҐГІ ГµГЁГІ
	...
	{
		//Г¤Г®ГЎГ ГўГЁГІГј ГЄГ°Г®ГўГј Г­Г  Г±ГІГҐГ­Г»
...
//РґРѕР±Р°РІР»РµРЅРёРµ РєСЂРѕРІР°РІС‹С… РѕС‚РјРµС‚РѕРє РЅР° СС‚РµРЅР°С…, РїРѕСР»Рµ РїРѕР»СѓС‡РµРЅРёС С…РёС‚Р°
