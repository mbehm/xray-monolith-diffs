...
public:
	float m_fLR_ShootingFactor; // Фактор горизонтального �двига худа при �трельбе [-1; +1]
	float m_fUD_ShootingFactor; // Фактор вертикального �двига худа при �трельбе [-1; +1]
	float m_fBACKW_ShootingFactor; // Фактор �двига худа в �торону лица при �трельбе [0; +1]
public:
	...
	//--> [От 1.0 - Инерци� от бедра, до 0.0 - Инерци� при зумме] Какую инерцию и�пользовать
